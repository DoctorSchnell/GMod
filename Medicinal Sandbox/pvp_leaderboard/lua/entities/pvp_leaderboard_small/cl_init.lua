--[[
	PVP Leaderboard (Small) - Client
	Metal-framed 3D sign with leaderboard on both faces.
	Suitable for rooms and close-range viewing.
...
-- At 0.10, the 470-unit-wide screen spans ~47 game units.
local SCALE = 0.10

-- Metal frame border width in world units
local BORDER_SIZE = 0.5

-- Skip rendering beyond this distance squared (~400 units).
local RENDER_DIST_SQ = 160000
